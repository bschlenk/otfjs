...
export const MaxpTable = s.versioned('MaxpTable', s.u32(), {
  ...
  [0x00010000]: s.struct('MaxpTable10', {
    ...
    maxZones:              s.u16('1 if instructions do not use the twilight zone, 2 if they do'),
    maxTwilightPoints:     s.u16('Maximum points used in Z0'),
    maxStorage:            s.u16('Number of Storage Area locations'),
    maxFunctionDefs:       s.u16('Number of FDEFs, equal to the highest function number + 1'),
    ...
    maxComponentElements:  s.u16('Maximum number of components referenced at top level'),
    maxComponentDepth:     s.u16('Maximum levels of recursion; 1 for simple components'),
  }),
})
