...
Swift executable that runs the Apple TrueType reference interpreter on a font glyph and prints the hinted point coordinates as JSON.
...
The `x_hinted`/`y_hinted` values are in Apple's internal coordinate system (see discussion 0003). To convert to pixel floats:
